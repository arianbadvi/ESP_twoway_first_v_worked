...
void bno055_setup() {
  ...
  if (id != BNO055_ID) {
    ...
    bno055_delay(2000);
    sprintf(buffer_test, "Can't find BNO055, id: 0x%02x. Please check your wiring.\r\n", id);    
    put_str3(buffer_test);
    bno_state = 0;
  }
  bno055_setPage(0);
  ...
  */
  ...
  bno055_delay(10);
  /*
  bno055_writeData(BNO055_SYS_TRIGGER, 0x30);
  bno055_delay(10);
  */
  bno055_writeData(BNO055_SYS_TRIGGER, 0x01);
  bno055_delay(10);
